...
## Treaded player tire v1

The v4.18 presentation test uses the following generated-asset prompt with a
clean first-track gameplay crop as a proportion reference:

> Recreate one complete rear vehicle tire matching the chunky low-poly
> silhouette, rear-camera perspective, proportions, dark charcoal palette,
> and restrained Nintendo 64-era styling of the supplied gameplay reference.
> Add clearly readable rugged rubber tread blocks. Use crisp
> pixel-art-compatible edges, simple faceted shading, matte rubber, transparent
> background, and no rim, vehicle, road, shadow, text, logo, or additional
> objects.

The transparent subject bounds were cropped and deterministically resized to
420x528 RGBA. The frontend displays this at the measured 28x41 SNES
source-space wheel footprint, which corresponds to approximately 105x132
pixels in the sampled 1280x720 presentation.
