...
// or gravel. Green polygon slots are intentionally excluded because the road
// and shoulder reuse some of them; grass is applied only to the BG2 landscape.
// The RGB check makes the rule self-disabling when another scene repurposes the
// same palette index.
