# Reconstruction session recording v4.13
...
```text
python source/19-session-recorder-v4.13/source/tools/recording/inspect_recording.py recordings/<session>/session.srfxrec --verify
```

Reconstruct and extract the complete accumulated state at a chosen frame:

```text
python source/19-session-recorder-v4.13/source/tools/recording/inspect_recording.py recordings/<session>/session.srfxrec --verify --frame 2500 --output <folder>
```
